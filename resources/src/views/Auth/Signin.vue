        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          <div class="w-full max-w-md pt-10 mx-auto">
            ...
            >
              ...
              {{ t('auth.login.back_to_dashboard') }}
            </router-link>
          </div>
                ...
                <div class="space-y-5">
                  <div>
                    <label for="email" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                      {{ t('auth.login.fields.email.label') }}<span class="text-error-500">*</span>
                    </label>
                    <input
                      v-model="email"
                      type="email"
                  ...
                  <div>
                    <label for="password" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                      {{ t('auth.login.fields.password.label') }}<span class="text-error-500">*</span>
                    </label>
                    <div class="relative">
                      <input
                        v-model="password"
                  ...
                  <div>
                    ...
                    >
                      <span v-if="authStore.isLoading" class="flex items-center">
                        ...
                        {{ t('auth.login.submit_button_loading') }}
                      </span>
        ...
        <div class="relative items-center hidden w-full h-full lg:w-1/2 bg-brand-950 dark:bg-white/5 lg:grid">
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <!-- Tu peux traduire ce texte via auth.banner si besoin -->
...
const handleSubmit = async () => {
  ...
  try {
    ...
    errorMessage.value = err.message || t('auth.messages.login.error.unexpected')
  }
}
</script>
